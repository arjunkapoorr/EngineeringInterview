...
public class ecdata extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ecdata);
        Bundle extras = getIntent().getExtras();
        String value = extras.getString("senddataec");
        String value1 = extras.getString("senddata1ec");
        TextView textview = (TextView) findViewById(R.id.datatextec);
    ...
    {
        Intent intent = new Intent(this, ec.class);
