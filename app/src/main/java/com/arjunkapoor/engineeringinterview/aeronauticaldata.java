...
public class aeronauticaldata extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_aeronauticaldata);
        Bundle extras = getIntent().getExtras();
        String value = extras.getString("senddataaeronautical");
        String value1 = extras.getString("senddata1aeronautical");
        TextView textview = (TextView) findViewById(R.id.datatextaeronautical);
    ...
    {
        Intent intent = new Intent(this, aeronautical.class);
