...
public class chemicaldata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chemicaldata);
        Bundle extras = getIntent().getExtras();
        String value = extras.getString("senddatachemical");
        String value1 = extras.getString("senddata1chemical");
        TextView textview = (TextView) findViewById(R.id.datatextchemical);
    ...
    {
        Intent intent = new Intent(this, chemical.class);
