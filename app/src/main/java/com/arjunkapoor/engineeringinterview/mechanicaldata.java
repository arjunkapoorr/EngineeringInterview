...
public class mechanicaldata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanicaldata);
        Bundle extras = getIntent().getExtras();
        String value = extras.getString("senddatamechanical");
        String value1 = extras.getString("senddata1mechanical");
        TextView textview = (TextView) findViewById(R.id.datatextmechanical);
