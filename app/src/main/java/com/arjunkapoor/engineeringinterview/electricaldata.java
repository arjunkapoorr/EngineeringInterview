...
public class electricaldata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electricaldata);
        Bundle extras = getIntent().getExtras();
        String value = extras.getString("senddataelectrical");
        String value1 = extras.getString("senddata1electrical");
        TextView textview = (TextView) findViewById(R.id.datatextelectrical);
