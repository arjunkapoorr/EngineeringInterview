...
public class eidata extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eidata);
        Bundle extras = getIntent().getExtras();
        String value = extras.getString("senddataei");
        String value1 = extras.getString("senddata1ei");
        TextView textview = (TextView) findViewById(R.id.datatextei);
