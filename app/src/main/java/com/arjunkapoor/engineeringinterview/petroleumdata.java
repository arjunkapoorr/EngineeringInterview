...
public class petroleumdata extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_petroleumdata);
        Bundle extras = getIntent().getExtras();
        String value = extras.getString("senddatapetroleum");
        String value1 = extras.getString("senddata1petroleum");
        TextView textview = (TextView) findViewById(R.id.datatextpetroleum);
    ...
    {
        Intent intent = new Intent(this, petroleum.class);
